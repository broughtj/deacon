...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/home/brough/anaconda3/lib/python3.5/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/home/brough/anaconda3/lib/python3.5/site-packages/numpy/core/include/numpy/ufuncobject.h"
        ],
        "include_dirs": [
            "/home/brough/anaconda3/lib/python3.5/site-packages/numpy/core/include",
            "."
        ],
        "language": "c++"
    },
    "module_name": "deacon.utils.rand"
}
END: Cython Metadata */
...
#define __PYX_HAVE__deacon__utils__rand
#define __PYX_HAVE_API__deacon__utils__rand
#include <random>
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'deacon.utils.rand' */
...
static __Pyx_memviewslice __pyx_f_6deacon_5utils_4rand_rnorm(unsigned int, unsigned int, double, double, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "deacon.utils.rand"
int __pyx_module_is_main_deacon__utils__rand = 0;

/* Implementation of 'deacon.utils.rand' */
...
static PyObject *__pyx_pf_6deacon_5utils_4rand_rnorm(CYTHON_UNUSED PyObject *__pyx_self, unsigned int __pyx_v_nreps, unsigned int __pyx_v_seed, double __pyx_v_mean, double __pyx_v_sd); /* proto */
...
static PyObject *__pyx_pw_6deacon_5utils_4rand_1rnorm(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_6deacon_5utils_4rand_rnorm(unsigned int __pyx_v_nreps, unsigned int __pyx_v_seed, double __pyx_v_mean, double __pyx_v_sd, CYTHON_UNUSED int __pyx_skip_dispatch) {
  __Pyx_memviewslice __pyx_v_values = { 0, 0, { 0 }, { 0 }, { 0 } };
  std::mt19937 __pyx_v_gen;
  std::normal_distribution<double>  __pyx_v_dist;
  ...
  size_t __pyx_t_9;
  int __pyx_t_10;
  __Pyx_RefNannySetupContext("rnorm", 0);

  /* "deacon/utils/rand.pyx":15
 * 
 * cpdef double[::1] rnorm(unsigned int nreps, unsigned int seed, double mean, double sd):
 *     cdef double[::1] values = np.zeros(nreps, dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef mt19937 gen = mt19937(seed)
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_nreps); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_v_dist = std::normal_distribution<double> (__pyx_v_mean, __pyx_v_sd);

  /* "deacon/utils/rand.pyx":20
 *     cdef unsigned int i
 * 
 ...
 * 
 */
  __pyx_t_7 = __pyx_v_nreps;
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    __pyx_v_i = __pyx_t_8;

    /* "deacon/utils/rand.pyx":21
 * 
 *     for i in range(nreps):
 *         values[i] = dist(gen)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_9 = __pyx_v_i;
    __pyx_t_10 = -1;
    if (unlikely(__pyx_t_9 >= (size_t)__pyx_v_values.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 21, __pyx_L1_error)
    }
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_values.data) + __pyx_t_9)) )) = __pyx_v_dist(__pyx_v_gen);
  }

  /* "deacon/utils/rand.pyx":23
 *         values[i] = dist(gen)
 * 
 *     return values             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("deacon.utils.rand.rnorm", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
/* Python wrapper */
static PyObject *__pyx_pw_6deacon_5utils_4rand_1rnorm(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6deacon_5utils_4rand_1rnorm(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  unsigned int __pyx_v_nreps;
  unsigned int __pyx_v_seed;
  double __pyx_v_mean;
  double __pyx_v_sd;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("rnorm (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_nreps,&__pyx_n_s_seed,&__pyx_n_s_mean,&__pyx_n_s_sd,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nreps)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_seed)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("rnorm", 1, 4, 4, 1); __PYX_ERR(0, 14, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mean)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("rnorm", 1, 4, 4, 2); __PYX_ERR(0, 14, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sd)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("rnorm", 1, 4, 4, 3); __PYX_ERR(0, 14, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "rnorm") < 0)) __PYX_ERR(0, 14, __pyx_L3_error)
      }
    ...
    __pyx_v_nreps = __Pyx_PyInt_As_unsigned_int(values[0]); if (unlikely((__pyx_v_nreps == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_seed = __Pyx_PyInt_As_unsigned_int(values[1]); if (unlikely((__pyx_v_seed == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_mean = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_mean == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_sd = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_sd == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("rnorm", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 14, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("deacon.utils.rand.rnorm", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6deacon_5utils_4rand_rnorm(__pyx_self, __pyx_v_nreps, __pyx_v_seed, __pyx_v_mean, __pyx_v_sd);
...
static PyObject *__pyx_pf_6deacon_5utils_4rand_rnorm(CYTHON_UNUSED PyObject *__pyx_self, unsigned int __pyx_v_nreps, unsigned int __pyx_v_seed, double __pyx_v_mean, double __pyx_v_sd) {
  ...
  __pyx_t_1 = __pyx_f_6deacon_5utils_4rand_rnorm(__pyx_v_nreps, __pyx_v_seed, __pyx_v_mean, __pyx_v_sd, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 14, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "deacon.utils.rand.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "deacon.utils.rand.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "deacon.utils.rand.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "deacon.utils.rand._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"rnorm", (PyCFunction)__pyx_pw_6deacon_5utils_4rand_1rnorm, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_deacon__utils__rand) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "deacon.utils.rand")) {
      if (unlikely(PyDict_SetItemString(modules, "deacon.utils.rand", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("rnorm", (void (*)(void))__pyx_f_6deacon_5utils_4rand_rnorm, "__Pyx_memviewslice (unsigned int, unsigned int, double, double, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init deacon.utils.rand", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init deacon.utils.rand");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
